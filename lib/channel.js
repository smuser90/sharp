 ...
 */
var extractChannel = function extractChannel (channel) {
  if (channel === 'red') {
    channel = 0;
 ...
 * @param {Object} options - image options, see `sharp()` varructor.
 * @returns {Sharp}
 * @throws {Error} Invalid parameters
 */
var joinChannel = function joinChannel (images, options) {
 ...
 * @throws {Error} Invalid parameters
 */
var bandbool = function bandbool (boolOp) {
