 ...
 */
var toFile = function toFile (fileOut, callback) {
 ...
 */
var toBuffer = function toBuffer (callback) {
  return this._pipeline(callback);
};
 ...
 * @throws {Error} Invalid parameters
 */
var withMetadata = function withMetadata (withMetadata) {
 ...
 */
var jpeg = function jpeg (options) {
 ...
 * @throws {Error} Invalid options
 */
var webp = function webp (options) {
 ...
 * @throws {Error} Invalid options
 */
var tiff = function tiff (options) {
  if (is.object(options) && is.defined(options.quality)) {
    if (is.integer(options.quality) && is.inRange(options.quality, 1, 100)) {
 ...
 */
var toFormat = function toFormat (format, options) {
 ...
 * @returns {Sharp}
 */
var _updateFormatOut = function _updateFormatOut (formatOut, options) {
 ...
 */
var _setBooleanOption = function _setBooleanOption (key, val) {
  if (is.bool(val)) {
 ...
 * @private
 */
var _pipeline = function _pipeline (callback) {
  var that = this;
...
var quality = util.deprecate(function (quality) {
...
/* istanbul ignore next */
var progressive = util.deprecate(function (progressive) {
  var formatOut = this.options.formatOut;
...
/* istanbul ignore next */
var compressionLevel = util.deprecate(function (compressionLevel) {
  var formatOut = this.options.formatOut;
...
/* istanbul ignore next */
var withoutAdaptiveFiltering = util.deprecate(function (withoutAdaptiveFiltering) {
  var formatOut = this.options.formatOut;
...
/* istanbul ignore next */
var withoutChromaSubsampling = util.deprecate(function (withoutChromaSubsampling) {
  var formatOut = this.options.formatOut;
...
/* istanbul ignore next */
var trellisQuantisation = util.deprecate(function (trellisQuantisation) {
  var formatOut = this.options.formatOut;
...
/* istanbul ignore next */
var overshootDeringing = util.deprecate(function (overshootDeringing) {
  var formatOut = this.options.formatOut;
...
/* istanbul ignore next */
var optimiseScans = util.deprecate(function (optimiseScans) {
  var formatOut = this.options.formatOut;
