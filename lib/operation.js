 ...
 * @throws {Error} Invalid parameters
 */
var sharpen = function sharpen (sigma, flat, jagged) {
  if (!is.defined(sigma)) {
 ...
 * @throws {Error} Invalid parameters
*/
var extend = function extend (extend) {
 ...
 * @returns {Sharp}
 */
var flatten = function flatten (flatten) {
 ...
 * @throws {Error} Invalid parameters
 */
var trim = function trim (tolerance) {
 ...
 * @throws {Error} Invalid parameters
 */
var gamma = function gamma (gamma) {
  if (!is.defined(gamma)) {
 ...
 * @returns {Sharp}
 */
var negate = function negate (negate) {
 ...
 * @returns {Sharp}
 */
var normalise = function normalise (normalise) {
 ...
 * @returns {Sharp}
 */
var normalize = function normalize (normalize) {
 ...
 * @throws {Error} Invalid parameters
 */
var convolve = function convolve (kernel) {
 ...
 * @throws {Error} Invalid parameters
 */
var threshold = function threshold (threshold, options) {
 ...
 * @throws {Error} Invalid parameters
 */
var boolean = function boolean (operand, operator, options) {
